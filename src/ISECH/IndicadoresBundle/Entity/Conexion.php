...
/**
 * ISECH\IndicadoresBundle\Entity\Conexion
 *
 * @ORM\Table(name="conexion")
 * @ORM\Entity(repositoryClass="ISECH\IndicadoresBundle\Entity\ConexionRepository")
 */
class Conexion
{
    /**
     ...
     * Set idMotor
     *
     * @param  ISECH\IndicadoresBundle\Entity\MotorBd $idMotor
     * @return Conexion
     */
    public function setIdMotor(\ISECH\IndicadoresBundle\Entity\MotorBd $idMotor = null)
    {
     ...
     * Get idMotor
     *
     * @return ISECH\IndicadoresBundle\Entity\MotorBd
     */
     ...
     * Add origenes
     *
     * @param  \ISECH\IndicadoresBundle\Entity\OrigenDatos $origenes
     * @return Conexion
     */
    public function addOrigene(\ISECH\IndicadoresBundle\Entity\OrigenDatos $origenes)
    {
     ...
     * @param \ISECH\IndicadoresBundle\Entity\OrigenDatos $origenes
     */
    public function removeOrigene(\ISECH\IndicadoresBundle\Entity\OrigenDatos $origenes)
    {
