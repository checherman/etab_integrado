...
/**
 * ISECH\IndicadoresBundle\Entity\GrupoIndicadoresIndicador
 *
...
class GrupoIndicadoresIndicador
{
     ...
     * @return GrupoIndicadoresIndicador
     */
    public function setIndicador(\ISECH\IndicadoresBundle\Entity\FichaTecnica $indicador)
    {
     ...
     * Set grupo
     *
     * @param  \ISECH\IndicadoresBundle\Entity\GrupoIndicadores $grupo
     * @return GrupoIndicadoresIndicador
     */
    public function setGrupo(\ISECH\IndicadoresBundle\Entity\GrupoIndicadores $grupo)
    {
        $this->grupo = $grupo;
