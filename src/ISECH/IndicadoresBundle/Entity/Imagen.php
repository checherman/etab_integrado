...
/**
 * ISECH\IndicadoresBundle\Entity;
 *
 * @ORM\Entity
...
class Imagen
{
     ...
     * Set sala
     *
     * @param \ISECH\IndicadoresBundle\Entity\GrupoIndicadores $sala
     * @return Image
     */
    public function setSala(\ISECH\IndicadoresBundle\Entity\GrupoIndicadores $sala = null)
    {
        $this->sala = $sala;
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        $resolver->setDefaults(array('data_class' =>'ISECH\IndicadoresBundle\Entity\Imagen'));
    }
     ...
     * @return Imagen
     */
    public function setUsuario(\ISECH\IndicadoresBundle\Entity\User $usuario = null)
    {
