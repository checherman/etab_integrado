...
/**
 * ISECH\IndicadoresBundle\Entity\IndicadorAlertas
 *
...
class IndicadorAlertas
{
     ...
     * Set color
     *
     * @param  ISECH\IndicadoresBundle\Entity\Alerta $color
     * @return IndicadorAlertas
     */
    public function setColor(\ISECH\IndicadoresBundle\Entity\Alerta $color = null)
    {
        $this->color = $color;
     ...
     * Get color
     *
     * @return ISECH\IndicadoresBundle\Entity\Alerta
     */
     ...
     * Set indicador
     *
     * @param  ISECH\IndicadoresBundle\Entity\FichaTecnica $indicador
     * @return IndicadorAlertas
     */
    public function setIndicador(\ISECH\IndicadoresBundle\Entity\FichaTecnica $indicador = null)
    {
     ...
     * Get indicador
     *
     * @return ISECH\IndicadoresBundle\Entity\FichaTecnica
     */
