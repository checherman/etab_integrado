...
/**
 * ISECH\IndicadoresBundle\Entity\OrigenDatos
 *
 * @ORM\Table(name="origen_datos")
 * @ORM\Entity(repositoryClass="ISECH\IndicadoresBundle\Entity\OrigenDatosRepository")
...
class OrigenDatos
{
    ...
    * Set ventana
     ...
     * Set periodicidad
     *
     * @param \ISECH\IndicadoresBundle\Entity\Periodos $periodicidad
     * @return OrigenDatos
     */
    public function setPeriodicidad(\ISECH\IndicadoresBundle\Entity\Periodos $periodicidad = null)
    {
     ...
     *
     * @param \ISECH\IndicadoresBundle\Entity\ReporteActualizacion $reporteActualizaciones
     * @return OrigenDatos
     */
    public function addReporteActualizaciones(\ISECH\IndicadoresBundle\Entity\ReporteActualizacion $reporteActualizaciones) {
     ...
     * Add fusiones
     *
     * @param  ISECH\IndicadoresBundle\Entity\OrigenDatos $fusiones
     * @return OrigenDatos
     */
    public function addFusione(\ISECH\IndicadoresBundle\Entity\OrigenDatos $fusiones)
    {
     ...
     * @param ISECH\IndicadoresBundle\Entity\OrigenDatos $fusiones
     */
    public function removeFusione(\ISECH\IndicadoresBundle\Entity\OrigenDatos $fusiones)
    {
     ...
     * Add conexiones
     *
     * @param  \ISECH\IndicadoresBundle\Entity\Conexion $conexiones
     * @return OrigenDatos
     */
    public function addConexione(\ISECH\IndicadoresBundle\Entity\Conexion $conexiones)
    {
     ...
     * @param \ISECH\IndicadoresBundle\Entity\Conexion $conexiones
     */
    public function removeConexione(\ISECH\IndicadoresBundle\Entity\Conexion $conexiones)
    {
     ...
     * @return OrigenDatos
     */
    public function addReporteActualizacione(\ISECH\IndicadoresBundle\Entity\ReporteActualizacion $reporteActualizaciones)
    {
        $this->reporteActualizaciones[] = $reporteActualizaciones;
     ...
     * @param \ISECH\IndicadoresBundle\Entity\ReporteActualizacion $reporteActualizaciones
     */
    public function removeReporteActualizacione(\ISECH\IndicadoresBundle\Entity\ReporteActualizacion $reporteActualizaciones)
    {
