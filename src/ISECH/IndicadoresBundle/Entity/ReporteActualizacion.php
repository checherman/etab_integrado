...
/**
 * ISECH\IndicadoresBundle\Entity\ReporteActualizacion
 *
 * @ORM\Table(name="reporte_actualizacion")
 * @ORM\Entity(repositoryClass="ISECH\IndicadoresBundle\Entity\ReporteActualizacionRepository")
 */
class ReporteActualizacion
{
     ...
     * Set estatusAct
     *
     * @param \ISECH\IndicadoresBundle\Entity\EstatusActualizacion $estatusAct
     * @return ReporteActualizacion
     */
    public function setEstatusAct(\ISECH\IndicadoresBundle\Entity\EstatusActualizacion $estatusAct = null)
    {
     ...
     * Get estatusAct
     *
     * @return \ISECH\IndicadoresBundle\Entity\EstatusActualizacion 
     */
