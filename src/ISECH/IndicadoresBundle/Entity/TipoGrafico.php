...
/**
 * ISECH\IndicadoresBundle\Entity\TipoGrafico
 *
...
class TipoGrafico
{
     ...
     * Add significados
     *
     * @param  \ISECH\IndicadoresBundle\Entity\SignificadoCampo $significados
     * @return TipoGrafico
     */
    public function addSignificado(\ISECH\IndicadoresBundle\Entity\SignificadoCampo $significados)
    {
     ...
     * @param \ISECH\IndicadoresBundle\Entity\SignificadoCampo $significados
     */
    public function removeSignificado(\ISECH\IndicadoresBundle\Entity\SignificadoCampo $significados)
    {
